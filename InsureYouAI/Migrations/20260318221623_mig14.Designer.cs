...
namespace InsureYouAI.Migrations
{
    ...
    [Migration("20260318221623_mig14")]
    partial class mig14
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("InsureYouAI.Entities.PricingPlanItem", b =>
                {
                    ...
                    b.Property<int?>("PricingPlanItemId1")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("InsureYouAI.Entities.PricingPlanItem", b =>
                {
                    ...
                    b.HasOne("InsureYouAI.Entities.PricingPlanItem", null)
                        .WithMany("PricingPlanItems")
                        .HasForeignKey("PricingPlanItemId1");
